...
class JasminCode(MachineCode):
    ...
    def emitINVOKEVIRTUAL(self, lexeme, typ, para = None):
        # lexeme: String
        # typ: String
        # para: list of parameters
        para = "" if para == None else para             # str the para
        return JasminCode.INDENT + "invokevirtual " + lexeme + '(' + para + ')' + typ + JasminCode.END
