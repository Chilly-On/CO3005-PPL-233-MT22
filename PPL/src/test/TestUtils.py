...
from main.mt22.codegen.CodeGenerator import CodeGenerator
...
class TestLexer:
    ...
    def test(input, expect, num):
        ...
        line = dest.read()
        print('\n--------------------------')
        print('Testcase no.: ', num)            # output my input & expect
        print('Input: ', input)            # output my input & expect as AST tree
        print('Expect: ', expect)
        if not line == expect:
            print('FAILED\nYou: ', line)            # output my output in error
        return line == expect
...
class TestChecker:
    ...
    def test(input, expect, num):
        ...
        print('\n--------------------------')
        print('Testcase no.: ', num)            # output my input & expect
        print('Input: ', asttree)            # output my input & expect as AST tree
