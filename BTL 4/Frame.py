...
class Frame():
    def __init__(self, name, returnType):
        ...
        # for loop
        self.conLabel = list()  # store labels for loop control such as brk or cont
        self.brkLabel = list()
    ...
    *   In addition, this method also saves the current index of local variable.
    ...
    def enterScope(self, isProc):
        ...
        self.push()                         # create 2 push to proper with above
        self.push()
        self.startLabel.append(start)
        self.endLabel.append(end)
        self.indexLocal.append(self.currIndex)
        if isProc:                          # check if need to clear all data, in func call
            self.maxOpStackSize = 0
            self.maxIndex = 0
    ...
    *   and restore the current index
    ...
    def exitScope(self):
        ...
        self.startLabel.pop()
        self.endLabel.pop()
        self.pop()                              # create 2 pop to proper with above
        self.pop()
